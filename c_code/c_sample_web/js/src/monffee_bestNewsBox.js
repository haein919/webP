...
(function($){
  ...
  var newsData = [
    { title:'새로운 메뉴1',
      link:'#',
      img:'menu_01.png',
      content:'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto minima voluptates in ratione perferendis commodi et!'
    },
    { title:'새로운 메뉴2',
      link:'#',
      img:'menu_02.png',
  ...
  for(; i < newsData.length; i+=1 ){
    ...
    bestLi.find('.news_img').css({'background-image':'url('+ url + newsData[i].img + ')'});
